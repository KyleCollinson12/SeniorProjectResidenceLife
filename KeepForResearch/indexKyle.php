        ...
        <table>
          ...
          echo ' <tr> 
                <!-- FETCHING DATA FROM EACH
                    ROW OF EVERY COLUMN --> ';
                echo '<td>'; echo $studentData['FName']; echo '</td>';
                echo '<td>'; echo $studentData['LName'];echo '</td>';
                echo '<td>'; echo $dorm;echo '</td>';
                echo '<td>'; echo $studentData['Date'];echo '</td>';
                echo '<td>'; echo $studentData['Status'];echo '</td>';
        echo '</tr>';
